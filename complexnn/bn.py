...
def complex_standardization(input_centred, Vrr, Vii, Vri,
    ...
    if (axis == 1 and ndim != 3) or ndim == 2:
        ...
        raise ValueError(
            ...
            'axis: ' + str(axis) + '; ndim: ' + str(ndim) + '.' # str(self.axis) + '; ndim: ' + str(ndim) + '.'
        )
...
class QuaternionBatchNormalization(Layer):
    """Quaternion (complex) version of the real domain 
    ...
    def call(self, inputs, training=None):
        ...
        #### [CHECK_PRINT] ####
        # print("################\nQuat_Batch_Norm - check_print\n")
        # print("moving_mean: ", self.moving_mean)
        # print("gamma_rr: ", self.gamma_rr)
        # print("gamma_ii: ", self.gamma_ii)
        # print("gamma_ri: ", self.gamma_ri)
        # print("moving_Vrr: ", self.moving_Vrr)
        # print("moving_Vii: ", self.moving_Vii)
        # print("moving_Vri: ", self.moving_Vri)
        # print("###############\n")
        ####
